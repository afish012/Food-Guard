...
function getJSON(barcode) {
    ...
    $.getJSON("https://world.openfoodfacts.org/api/v0/product/" + barcode + ".json", function (result) {
        ...
        if (status == "product not found") {
            ...
            //Compare allergens from food facts database with user's specified allergens and highlight if there is a match
            ...
            //If allergens found display warning message
            if (danger) {
